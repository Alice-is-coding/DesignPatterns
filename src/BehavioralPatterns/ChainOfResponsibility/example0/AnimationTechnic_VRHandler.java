...
/**
 * ConcreteHandler.
 * Handles VR animation technics.
 *
 * @author Alice B.
 * @version 11/02/2021
 */
public class AnimationTechnic_VRHandler extends AnimationTechnic_Handler{
    /**
    ...
    protected boolean canHandleRequest(AnimationTechnic animationTechnic) {
        return animationTechnic instanceof AnimationTechnic_VR;
    }
}
