...
/**
 * ConcreteHandler.
 * Handles 3D animation technics.
 *
 * @author Alice B.
 * @version 11/02/2021
 */
public class AnimationTechnic_3DHandler extends AnimationTechnic_Handler{
    /**
    ...
    protected boolean canHandleRequest(AnimationTechnic animationTechnic) {
        return animationTechnic instanceof AnimationTechnic_3D;
    }
}
